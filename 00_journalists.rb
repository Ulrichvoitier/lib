...
#handle 5 lettres
def cinqlettres
   puts "Combien y a t-il de handle avec moins de 5 caractère ?"
   cinqlettres = 0
...
def petit
  puts "Trilleé par taille"
  @twitter.sort_by(& :length)
  petit = @twitter.sort_by(& :length)
end
puts petit
